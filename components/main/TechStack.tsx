...
function TechStack() {
    return (
        <section className="grid gap-2 p-5 md:p-0 font-fire-code dark:text-gray-300">
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 xl:grid-cols-4 gap-5">
                <Card className="lex flex-wrap gap-2 sm:w-56 w-fit dark:bg-gray-800/50 bg-slate-200/50">
                ...
                <Card className="lex flex-wrap gap-2 sm:w-56 w-fit dark:bg-gray-800/50 bg-slate-200/50">
                    ...
                    <CardContent className="text-xs text-primary p-2 grid grid-cols-1 gap-2 sm:grid-cols-2 dark:text-gray-300">
                        ...
                        <Badge className="border border-[#F1563B] w-fit">GIT</Badge>
